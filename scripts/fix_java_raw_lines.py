...
def repair_generated_line(line):
    ...
    # complete declaration rather than trying to repair individual backslashes;
    # this also fixes over-escaped character literals such as '\\\\r'.
    # Preserve any code emitted before/after the declaration on the same line.
