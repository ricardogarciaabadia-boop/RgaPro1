...
# Open the Client 360 activity from the client list, but do not fail the build
# when the source is already in the desired state.
...
if n == 1:
    ...
    raise SystemExit(f'unsupported detail replacement count={n}')

# Replace the home side-menu area only when the old markers are present.
...
# Back-button improvement is optional; apply only to the known old implementation.
