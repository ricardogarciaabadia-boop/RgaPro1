...
# Materialize the exact supplied RgaPro artwork into Android resources during CI.
logo_b64 = Path("branding/rgapro_logo.b64")
logo_out = Path("app/src/main/res/drawable/rgapro_logo.jpg")
logo_out.parent.mkdir(parents=True, exist_ok=True)
logo_out.write_bytes(base64.b64decode(logo_b64.read_text(encoding="utf-8").strip()))
