...
public class MainActivity extends Activity {
    ...
    @Override public void onRequestPermissionsResult(int r,@NonNull String[] p,@NonNull int[] g){super.onRequestPermissionsResult(r,p,g);if(r==CAMERA_REQ&&g.length>0&&g[0]==PackageManager.PERMISSION_GRANTED)launchCamera();else if(r==CAMERA_REQ)Toast.makeText(this,"Necesito permiso de cámara para escanear documentos",Toast.LENGTH_LONG).show();}
